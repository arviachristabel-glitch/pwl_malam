            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('jurusan.destroy', $j->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Hapus jurusan ini?');">
                            @csrf @method('DELETE')
