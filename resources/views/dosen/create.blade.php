...
<div class="container">
    ...
    <form action="{{ route('dosen.store') }}" method="post">
        ...
        <div class="form-group">
            <label>NIDN</label>
            <input type="text" name="NIDN" placeholder="Masukkan NIDN" required>
        </div>
        <div class="form-group">
            <label>Pendidikan Terakhir</label>
            <input type="text" name="Pendidikan_Terakhir" placeholder="Contoh: S2 Teknik Informatika">
        </div>
        <div class="form-group">
            <label>ID Jurusan</label>
            <input type="number" name="Jurusan_id" placeholder="Masukkan ID Jurusan">
        </div>
        <div class="form-group">
        ...
        <div class="btn-group">
            ...
            <a href="{{ route('dosen.index') }}" class="btn btn-back">Kembali</a>
        </div>
    </form>
</div>
