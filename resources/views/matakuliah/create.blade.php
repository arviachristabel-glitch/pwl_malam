...
<div class="container">
    ...
    <form action="{{ route('matakuliah.store') }}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="Kode_MK" placeholder="Contoh: MK001" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" name="jurusan_id" placeholder="Masukkan ID Jurusan terkait">
        </div>
        <div class="form-group">
            <label>ID Dosen Pengampu</label>
            <input type="number" name="dosen_id" placeholder="Masukkan ID Dosen pengampu">
        </div>
        
        <div class="btn-group">
            <button type="submit" class="btn btn-save">Simpan MK</button>
